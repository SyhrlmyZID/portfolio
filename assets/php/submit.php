...
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['subject']) && isset($_POST['comment'])){
	...
	$mail->Username="syhrlmyz.id@gmail.com";  // Your Mail
	$mail->Password=""; // Your app password

	$mail->setFrom($email, $name);  
	$mail->addAddress("syhrlmyz.idl@gmail.com", "SyhrlmyZID"); // (Your Mail) An email address that will receive the email with the output of the form
